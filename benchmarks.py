...
active_learning_benchmarks = [
    ...
    Benchmark(
        Map(IsObject("person"), IsObject("person"), GetAbove()),
        "All people in back",
        "mscoco1",
    ),
    Benchmark(
        Intersection(
            [
                Map(IsObject("person"), IsObject("person"), GetNext()),
                Map(IsObject("person"), IsObject("person"), GetPrev()),
            ]
        ),
        "People that are between two other people",
        "mscoco1",
    ),
    Benchmark(
        Complement(Union([IsObject("car"), IsObject("truck")])),
        "All objects except cars and trucks",
        "mscoco1",
        ["../objects/000000436883.jpg"],
    ),
    Benchmark(
        Union([IsObject("car"), IsObject("truck")]),
        "All cars and trucks",
        "mscoco1",
    ),
    Benchmark(
        Map(IsObject("chair"), IsObject("person"), GetAbove()),
        "People sitting in chairs",
        "mscoco1",
        ["../objects/000000367095.jpg"],
    ),
    Benchmark(
        Map(IsObject("dining table"), IsObject("cup"), GetAbove()),
        "Cups on dining tables",
        "mscoco1",
        ["../objects/000000368752.jpg"],
    ),
    Benchmark(
        Map(IsObject("traffic light"), IsObject("car"), GetBelow()),
        "Cars below traffic lights",
        "mscoco1",
    ),
    Benchmark(
        Union(
            [IsObject("chair"), Map(IsObject("chair"), IsObject("person"), GetAbove())]
        ),
        "Chairs and people sitting in chairs",
        "mscoco1",
    ),
    Benchmark(
        Map(IsObject("car"), IsObject("person"), GetContains()),
        "All people within car",
        "mscoco1",
        ["../objects/000000460147.jpg"],
    ),
    Benchmark(
    ...
    Benchmark(
        Intersection(
            [
                IsObject("person"),
                Complement(Map(IsObject("car"), IsObject("person"), GetContains())),
            ]
        ),
        "People not in cars",
        "mscoco1",
        ["../objects/000000309391.jpg"],
    ),
]
